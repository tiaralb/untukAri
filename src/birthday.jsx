...
export default function BirthdayWebsite() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-screen flex items-center justify-center px-4 relative">
          <div className="text-center">
            {/* Big 30 */}
            <div className="mb-9 animate-float-3d">
              <div className="text-[15rem] md:text-[20rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-amber-200 via-amber-400 to-amber-600 leading-none text-neon animate-neon-pulse" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                30
              </div>
              <div className="text-3xl md:text-5xl text-amber-300 -mt-20 tracking-widest text-bold">
                YEARS LEGENDARY
              </div>
            </div>

            <div className="space-y-6 animate-expand" style={{ animationDelay: '0.3s' }}>
               <br />
              <h1 className="text-4xl md:text-7xl font-bold text-white text-display">
                Happy Birthday <br /> ❤️ Ari Ilham Ramadhan ❤️
              </h1>
               <br />
              <p className="text-2xl md:text-4xl text-amber-200">
                my handsome husband
              </p>
              <div className="flex justify-center gap-4 pt-8">
                <Star className="w-8 h-8 text-amber-400 animate-pulse" fill="currentColor" />
                <Trophy className="w-8 h-8 text-amber-400 animate-pulse" fill="currentColor" style={{ animationDelay: '0.2s' }} />
                <Zap className="w-8 h-8 text-amber-400 animate-pulse" fill="currentColor" style={{ animationDelay: '0.4s' }} />
              </div>
            </div>

            <div className="mt-12 animate-bounce">
              <div className="text-white/60 text-sm">Scroll untuk petualangan</div>
        ...
        <div className="py-20 px-4 relative">
          <h2 className="text-5xl md:text-7xl font-black text-center text-white mb-20 text-bold">
            PERJALANAN KE 30
          </h2>
          
          <div className="max-w-5xl mx-auto relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-amber-400 via-rose-500 to-purple-500"></div>
        ...
        <div className="py-20 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-2xl rounded-3xl p-12 md:p-16 border border-white/20 relative overflow-hidden">
              {/* Decorative elements */}
              ...
              <div className="relative z-10">
                <div className="flex justify-center mb-8 animate-float-3d">
                  <div className="bg-gradient-to-br from-amber-400 to-rose-500 p-8 rounded-full">
                    <Cake className="w-16 h-16 text-white" />
                  </div>
                </div>

                <h2 className="text-4xl md:text-5xl font-black text-center text-white mb-8 text-display">
                  Welcome to Your 30s Era! 🎉
                </h2>

                <div className="text-xl md:text-2xl text-gray-200 space-y-6 leading-relaxed text-center">
                  <p>
                ...
                <div className="flex justify-center mt-12">
                  <button
                    ...
                    className="group relative px-10 py-5 text-xl font-bold text-white bg-gradient-to-r from-amber-500 via-rose-500 to-purple-600 rounded-full overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-amber-500/50"
                  >
                ...
                {showMessage && (
                  <div className="mt-12 bg-gradient-to-br from-amber-500/20 via-rose-500/20 to-purple-500/20 border-2 border-amber-400/50 rounded-3xl p-8 animate-expand backdrop-blur-sm">
                    <div className="text-center space-y-4">
                      <div className="text-5xl mb-4">🎊✨🎁✨🎊</div>
                      <p className="text-2xl md:text-3xl font-bold text-amber-300 text-display">
                        Surprise Message!
                      </p>
        ...
        <div className="py-20 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-5xl md:text-7xl font-black text-white mb-4 text-bold">
                OUR STORY
              </h2>
            
            </div>

            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-amber-400/30 hover:border-amber-400/60 transition-all duration-300">
              <video 
                className="w-full"
                controls
              ...
              >
                ...
                {/* <source src="/videos/birthday-video.webm" type="video/webm" /> */}
        ...
        <div className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-5xl md:text-7xl font-black text-center text-white mb-16 text-bold">
              30 YEARS IN NUMBERS
            </h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={idx} className="text-center p-8 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-2xl border border-white/20 hover:scale-110 transition-transform duration-300">
                  <div className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-br from-amber-300 to-rose-400 mb-3 text-neon">
                    {stat.num}
                  </div>
        ...
        <div className="py-20 px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-rose-400 to-purple-400 text-display">
      ...
      <button
        onClick={toggleMusic}
        className="fixed bottom-8 right-8 z-50 bg-gradient-to-r from-amber-500 via-rose-500 to-purple-600 text-white p-5 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 border-2 border-white/30 backdrop-blur-sm"
